...
We can specify the number of decimal places for the mean, SD, median and IQR columns as well as the number of significant figures for the treatment effect estimate and 95% CI.
```{r, warning=FALSE, message=FALSE}
labtable(lab2, control="Placebo", intervention_levels=c("Intervention"), mean_dp=2, SD_dp=2, median_dp=2, IQR_dp=2,
         estimate_sf=4, CI_sf=4)
```
