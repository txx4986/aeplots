...
```{r, fig.dim=c(8, 6)}
aetable(df2, body_system_class="aebodsys", control="Placebo", intervention_levels=c("Intervention"), IRR=TRUE, variables = c("variable1", "variable2"), save_docx_path="table.docx")
```
